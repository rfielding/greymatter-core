...
defaults: {
	...
	images: {
		cli:               string | *"greymatter.jfrog.io/release-oci/greymatter-cli:4.5.7"
		operator:          string | *"greymatter.jfrog.io/release-oci/greymatter-operator:0.14.0" @tag(operator_image)
		vector:            string | *"timberio/vector:0.22.0-debian"
		observables:       string | *"greymatter.jfrog.io/release-oci/greymatter-audits:1.1.5"
