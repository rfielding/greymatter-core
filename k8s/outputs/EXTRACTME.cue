...
keycloak_manifests:          keycloak
keycloak_postgres_manifests: keycloak_postgres
...
k8s_manifests: list.Concat([
		...
		[ for x in keycloak_admin_password if config.enable_keycloak {x}],
		[ for x in keycloak_postgres_password if config.enable_keycloak {x}],
])
